...
global QuitScript, ShowCode, ClubType, SaveFile, UserNme, Passwrd, TextFile, OfficersInfo, FixedText, HTMLtext
...
with timeout of 600 seconds
	...
	set ShowCode to lowercase (text 1 through 4 of text returned of (display dialog "Enter Show Code." default answer "" buttons {"Cancel", "OK"} default button 2 with icon note))
end timeout
...
tell application "Google Chrome"
	...
	open location (("http://192.168.0.1/execpgm/clubcom?key=" & (uppercase ShowCode)) as text)
...
tell application "Google Chrome"
	...
	open location "http://192.168.0.1" & text 39 through -1 of WebPath
end tell
